...
exports.returnBibDBCollection = function(cb){
	MongoClient.connect(mongoConnectURL, function(err, db) {
		var collection = (exports.testOverride) ? db.collection('test') : db.collection('bib')
		cb (collection)
	})
...
exports.updateBibRecordWithDB = function(bib,collection,cb){
		collection.update({ _id : bib.id }, { $set: bib }, function(err,results) {
